...
public class userLoginController {
                    ...
                    while (resultSet.next()) {
                        if (UserName.equals(resultSet.getString("UserName")) && Password.equals(resultSet.getString("Pass"))) {
                           ...
                           // String FullName = resultSet.getString("FullName");;
                            changescene(event,"pHome.fxml", UserName);
    ...
    void gotoSuccessDialog(String message) throws IOException {
      ...
      //  AnchorPane loginPage = FXMLLoader.load(getClass().getResource("successDialog.fxml"));
    ...
    void changescene(ActionEvent event, String fxml, String UserName) throws IOException {
